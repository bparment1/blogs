...
zonal_var_df$zone <- as.factor(test$zone)
xyplot(value~date|zone,data=zonal_var_df)

var_df <- as.data.frame(stack(r_var,r_ref)

```


We note that average NDVI drop by 0.1 in areas that were flooded while area not flooded had slight increase on average. 
#

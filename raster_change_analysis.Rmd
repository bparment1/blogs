...
r_before_NDWI <- (r_before$Green - r_before$SWIR2) / (r_before$Green + r_before$SWIR2)
r_after_NDWI <- (r_after$Green - r_after$SWIR2) / (r_after$Green + r_after$SWIR2)
...
names(r_var) <- c("NDVI_1","NDVI_2","NDWI_1","NDWI_2")

...
We carry out the PCA on the raster stack by computing a square matrix and extracting hte eigenvectors and eigen values. We illustrate the process using the correlation matrix with the principal and eigen functions.
